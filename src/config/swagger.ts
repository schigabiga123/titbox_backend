  ...
  request: {
    query: paginationQuerySchema.extend({
      search: z
        ...
        .openapi({
          description:
            "JSON string filter. Example: {\"szfCode\":\"SZF-123\",\"assignedUserId\":\"user-1\",\"orderBy\":\"ASC\",\"task\":{\"pickupAddressContains\":\"Budapest\",\"deliveryAddressContains\":\"Kornye\",\"taskFilter\":\"open\",\"deadlineAfter\":\"2026-03-01T00:00:00.000Z\",\"assignedUserId\":\"user-1\",\"submittedUserId\":\"user-2\",\"status\":\"doing\",\"vontatoDataContains\":\"ABC-123\",\"potkocsiDataContains\":\"XYZ-456\"}}",
          example:
