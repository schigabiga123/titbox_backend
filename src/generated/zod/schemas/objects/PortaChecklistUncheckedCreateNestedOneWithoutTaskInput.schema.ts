...
export const PortaChecklistUncheckedCreateNestedOneWithoutTaskInputObjectSchema: z.ZodType<Prisma.PortaChecklistUncheckedCreateNestedOneWithoutTaskInput> = makeSchema() as unknown as z.ZodType<Prisma.PortaChecklistUncheckedCreateNestedOneWithoutTaskInput>;
export const PortaChecklistUncheckedCreateNestedOneWithoutTaskInputObjectZodSchema = makeSchema();
