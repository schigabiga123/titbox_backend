...
const makeSchema = () => z.object({
  ...
  changeDetails: z.literal(true).optional(),
  _all: z.literal(true).optional()
}).strict();
export const ProjectSyncLogItemCountAggregateInputObjectSchema: z.ZodType<Prisma.ProjectSyncLogItemCountAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.ProjectSyncLogItemCountAggregateInputType>;
export const ProjectSyncLogItemCountAggregateInputObjectZodSchema = makeSchema();
