...
export const ProjectSyncLogFindFirstSelectSchema: z.ZodType<Prisma.ProjectSyncLogSelect> = z.object({
...
export const ProjectSyncLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    startedAt: z.boolean().optional(),
    finishedAt: z.boolean().optional(),
...
export const ProjectSyncLogFindFirstSchema: z.ZodType<Prisma.ProjectSyncLogFindFirstArgs> = z.object({ select: ProjectSyncLogFindFirstSelectSchema.optional(), include: ProjectSyncLogIncludeObjectSchema.optional(), orderBy: z.union([ProjectSyncLogOrderByWithRelationInputObjectSchema, ProjectSyncLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectSyncLogWhereInputObjectSchema.optional(), cursor: ProjectSyncLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectSyncLogScalarFieldEnumSchema, ProjectSyncLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProjectSyncLogFindFirstArgs>;

export const ProjectSyncLogFindFirstZodSchema = z.object({ select: ProjectSyncLogFindFirstSelectSchema.optional(), include: ProjectSyncLogIncludeObjectSchema.optional(), orderBy: z.union([ProjectSyncLogOrderByWithRelationInputObjectSchema, ProjectSyncLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectSyncLogWhereInputObjectSchema.optional(), cursor: ProjectSyncLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectSyncLogScalarFieldEnumSchema, ProjectSyncLogScalarFieldEnumSchema.array()]).optional() }).strict();