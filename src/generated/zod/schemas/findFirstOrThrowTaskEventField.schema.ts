...
export const TaskEventFieldFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TaskEventFieldSelect> = z.object({
...
export const TaskEventFieldFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskEventId: z.boolean().optional(),
    name: z.boolean().optional(),
    data: z.boolean().optional(),
