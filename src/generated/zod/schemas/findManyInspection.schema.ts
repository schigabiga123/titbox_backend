...
export const InspectionFindManySelectSchema: z.ZodType<Prisma.InspectionSelect> = z.object({
...
export const InspectionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    key: z.boolean().optional(),
    checked: z.boolean().optional(),
