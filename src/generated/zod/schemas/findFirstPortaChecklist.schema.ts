...
export const PortaChecklistFindFirstSelectSchema: z.ZodType<Prisma.PortaChecklistSelect> = z.object({
...
export const PortaChecklistFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    isUserChecked: z.boolean().optional(),
    isTruckChecked: z.boolean().optional(),
...
export const PortaChecklistFindFirstSchema: z.ZodType<Prisma.PortaChecklistFindFirstArgs> = z.object({ select: PortaChecklistFindFirstSelectSchema.optional(), include: PortaChecklistIncludeObjectSchema.optional(), orderBy: z.union([PortaChecklistOrderByWithRelationInputObjectSchema, PortaChecklistOrderByWithRelationInputObjectSchema.array()]).optional(), where: PortaChecklistWhereInputObjectSchema.optional(), cursor: PortaChecklistWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PortaChecklistScalarFieldEnumSchema, PortaChecklistScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PortaChecklistFindFirstArgs>;

export const PortaChecklistFindFirstZodSchema = z.object({ select: PortaChecklistFindFirstSelectSchema.optional(), include: PortaChecklistIncludeObjectSchema.optional(), orderBy: z.union([PortaChecklistOrderByWithRelationInputObjectSchema, PortaChecklistOrderByWithRelationInputObjectSchema.array()]).optional(), where: PortaChecklistWhereInputObjectSchema.optional(), cursor: PortaChecklistWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PortaChecklistScalarFieldEnumSchema, PortaChecklistScalarFieldEnumSchema.array()]).optional() }).strict();