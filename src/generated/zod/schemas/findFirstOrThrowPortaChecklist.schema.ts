...
export const PortaChecklistFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PortaChecklistSelect> = z.object({
...
export const PortaChecklistFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    isUserChecked: z.boolean().optional(),
    isTruckChecked: z.boolean().optional(),
...
export const PortaChecklistFindFirstOrThrowSchema: z.ZodType<Prisma.PortaChecklistFindFirstOrThrowArgs> = z.object({ select: PortaChecklistFindFirstOrThrowSelectSchema.optional(), include: PortaChecklistIncludeObjectSchema.optional(), orderBy: z.union([PortaChecklistOrderByWithRelationInputObjectSchema, PortaChecklistOrderByWithRelationInputObjectSchema.array()]).optional(), where: PortaChecklistWhereInputObjectSchema.optional(), cursor: PortaChecklistWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PortaChecklistScalarFieldEnumSchema, PortaChecklistScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PortaChecklistFindFirstOrThrowArgs>;

export const PortaChecklistFindFirstOrThrowZodSchema = z.object({ select: PortaChecklistFindFirstOrThrowSelectSchema.optional(), include: PortaChecklistIncludeObjectSchema.optional(), orderBy: z.union([PortaChecklistOrderByWithRelationInputObjectSchema, PortaChecklistOrderByWithRelationInputObjectSchema.array()]).optional(), where: PortaChecklistWhereInputObjectSchema.optional(), cursor: PortaChecklistWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PortaChecklistScalarFieldEnumSchema, PortaChecklistScalarFieldEnumSchema.array()]).optional() }).strict();