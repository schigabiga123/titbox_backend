...
export const ProjectSyncLogItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProjectSyncLogItemSelect> = z.object({
...
export const ProjectSyncLogItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    syncLogId: z.boolean().optional(),
    projectId: z.boolean().optional(),
...
export const ProjectSyncLogItemFindFirstOrThrowSchema: z.ZodType<Prisma.ProjectSyncLogItemFindFirstOrThrowArgs> = z.object({ select: ProjectSyncLogItemFindFirstOrThrowSelectSchema.optional(), include: ProjectSyncLogItemIncludeObjectSchema.optional(), orderBy: z.union([ProjectSyncLogItemOrderByWithRelationInputObjectSchema, ProjectSyncLogItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectSyncLogItemWhereInputObjectSchema.optional(), cursor: ProjectSyncLogItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectSyncLogItemScalarFieldEnumSchema, ProjectSyncLogItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProjectSyncLogItemFindFirstOrThrowArgs>;

export const ProjectSyncLogItemFindFirstOrThrowZodSchema = z.object({ select: ProjectSyncLogItemFindFirstOrThrowSelectSchema.optional(), include: ProjectSyncLogItemIncludeObjectSchema.optional(), orderBy: z.union([ProjectSyncLogItemOrderByWithRelationInputObjectSchema, ProjectSyncLogItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectSyncLogItemWhereInputObjectSchema.optional(), cursor: ProjectSyncLogItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectSyncLogItemScalarFieldEnumSchema, ProjectSyncLogItemScalarFieldEnumSchema.array()]).optional() }).strict();