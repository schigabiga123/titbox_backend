...
export const TaskFieldFindManySelectSchema: z.ZodType<Prisma.TaskFieldSelect> = z.object({
...
export const TaskFieldFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    pocketId: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const TaskFieldFindManySchema: z.ZodType<Prisma.TaskFieldFindManyArgs> = z.object({ select: TaskFieldFindManySelectSchema.optional(), include: TaskFieldIncludeObjectSchema.optional(), orderBy: z.union([TaskFieldOrderByWithRelationInputObjectSchema, TaskFieldOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskFieldWhereInputObjectSchema.optional(), cursor: TaskFieldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskFieldScalarFieldEnumSchema, TaskFieldScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskFieldFindManyArgs>;

export const TaskFieldFindManyZodSchema = z.object({ select: TaskFieldFindManySelectSchema.optional(), include: TaskFieldIncludeObjectSchema.optional(), orderBy: z.union([TaskFieldOrderByWithRelationInputObjectSchema, TaskFieldOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskFieldWhereInputObjectSchema.optional(), cursor: TaskFieldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskFieldScalarFieldEnumSchema, TaskFieldScalarFieldEnumSchema.array()]).optional() }).strict();