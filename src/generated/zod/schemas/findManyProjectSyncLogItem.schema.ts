...
export const ProjectSyncLogItemFindManySelectSchema: z.ZodType<Prisma.ProjectSyncLogItemSelect> = z.object({
...
export const ProjectSyncLogItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    syncLogId: z.boolean().optional(),
    projectId: z.boolean().optional(),
...
export const ProjectSyncLogItemFindManySchema: z.ZodType<Prisma.ProjectSyncLogItemFindManyArgs> = z.object({ select: ProjectSyncLogItemFindManySelectSchema.optional(), include: ProjectSyncLogItemIncludeObjectSchema.optional(), orderBy: z.union([ProjectSyncLogItemOrderByWithRelationInputObjectSchema, ProjectSyncLogItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectSyncLogItemWhereInputObjectSchema.optional(), cursor: ProjectSyncLogItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectSyncLogItemScalarFieldEnumSchema, ProjectSyncLogItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProjectSyncLogItemFindManyArgs>;

export const ProjectSyncLogItemFindManyZodSchema = z.object({ select: ProjectSyncLogItemFindManySelectSchema.optional(), include: ProjectSyncLogItemIncludeObjectSchema.optional(), orderBy: z.union([ProjectSyncLogItemOrderByWithRelationInputObjectSchema, ProjectSyncLogItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectSyncLogItemWhereInputObjectSchema.optional(), cursor: ProjectSyncLogItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectSyncLogItemScalarFieldEnumSchema, ProjectSyncLogItemScalarFieldEnumSchema.array()]).optional() }).strict();