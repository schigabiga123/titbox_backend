...
export const LibraFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LibraSelect> = z.object({
...
export const LibraFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    projectId: z.boolean().optional(),
    taskId: z.boolean().optional(),
    szfCode: z.boolean().optional(),
...
export const LibraFindFirstOrThrowSchema: z.ZodType<Prisma.LibraFindFirstOrThrowArgs> = z.object({ select: LibraFindFirstOrThrowSelectSchema.optional(), include: LibraIncludeObjectSchema.optional(), orderBy: z.union([LibraOrderByWithRelationInputObjectSchema, LibraOrderByWithRelationInputObjectSchema.array()]).optional(), where: LibraWhereInputObjectSchema.optional(), cursor: LibraWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LibraScalarFieldEnumSchema, LibraScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LibraFindFirstOrThrowArgs>;

export const LibraFindFirstOrThrowZodSchema = z.object({ select: LibraFindFirstOrThrowSelectSchema.optional(), include: LibraIncludeObjectSchema.optional(), orderBy: z.union([LibraOrderByWithRelationInputObjectSchema, LibraOrderByWithRelationInputObjectSchema.array()]).optional(), where: LibraWhereInputObjectSchema.optional(), cursor: LibraWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LibraScalarFieldEnumSchema, LibraScalarFieldEnumSchema.array()]).optional() }).strict();