...
export const TaskEventFindManySelectSchema: z.ZodType<Prisma.TaskEventSelect> = z.object({
...
export const TaskEventFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    name: z.boolean().optional(),
    createdAt: z.boolean().optional(),
